            ...
            <div class="max-w-6xl mx-auto ">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 ">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-8">
                        ...
                        <div class="mt-10">
                            ...
                            <div class="flex space-x-4">
                                <a href="#" class="bg-primary/10 hover:bg-primary text-primary hover:text-white p-3 rounded-full transition-all">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-8">
                        ...
                        <div id="success-message" class="hidden bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-6">
                        ...
                        <form action="https://formsubmit.co/shresthaprajjwol444@gmail.com" method="POST" id="contact-form">
                            <!-- Honeypot -->
