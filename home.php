...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <a href="/digital_bhatti/menu/menu.php" class="btn">Order Now</a>
        </div>
    </section>
            ...
            <div class="menu-slider">
                <div class="menu-items">
                    ...
                    <div class="menu-item">
                        ...
                        <p>A traditional Nepali meal with rice, dal, meat, vegetables, pickles, and ghee for a wholesome
                            experience.</p>
            ...
            <div class="chefs-slider">
                <div class="chefs-items">
                    <div class="chef-item">
                        ...
                        <h3>Gordon Ramsay</h3>
                        <p>A Michelin-starred British chef known for his fiery personality and shows like Hell’s Kitchen
                            and MasterChef.</p>
                    </div>
                    <div class="chef-item">
                        <img src="uploads/vikas.jpg" alt="Vikas">
                        <h3>Vikas Khanna</h3>
                        <p>An Indian Michelin-starred chef, author, and humanitarian known for his New York restaurant
                            Junoon and MasterChef India.</p>
                    </div>
                    <div class="chef-item">
                        <img src="uploads/santosh.jpg" alt="Santosh">
                        <h3>Santosh Shah</h3>
                        <p>A Nepalese chef who gained fame as a finalist on MasterChef: The Professionals UK, promoting
                            Nepalese cuisine globally.</p>
                    </div>
                    <div class="chef-item">
                        <img src="uploads/sanjeev.jpeg" alt="Sanjeev">
                        <h3>Sanjeev Kapoor</h3>
                        <p>One of India’s most famous chefs, known for hosting Khana Khazana and revolutionizing home
                            cooking in India.</p>
                    </div>
                    <div class="chef-item">
                        <img src="uploads/nick.jpg" alt="Nick">
                        <h3>Nick DiGiovanni</h3>
                        <p>An American chef, YouTuber, and MasterChef finalist known for his viral cooking videos and
                            creative recipes.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="reviews-slider">
                ...
                <div class="review-item">
                    <p class="review-text">"The only thing faster than my online food order is my mom switching TV
                        channels during ad breaks. The Thakali set arrived so fresh that I almost believed it was cooked
                ...
                <div class="review-item">
                    <p class="review-text">"Ordered fries, expected good food. Got fries so crispy that even my life
                        decisions feel soft in comparison. The delivery guy arrived faster than my relatives when they
                ...
                <div class="review-item">
                    <p class="review-text">"I swear, ordering from this app is smoother than my attempts at flirting.
                        The UI is cleaner than my room, and the food? Let’s just say I may or may not have proposed to
