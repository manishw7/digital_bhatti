...
<body>
    <footer class="bg-dark text-white py-10 mt-6">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-2xl font-bold text-primary mb-6">Digital Bhatti</h3>
                    <p class="mb-6">Serving authentic Nepali cuisine with a modern twist. Our mission is to bring the
                        flavors of Nepal to your doorstep.</p>
                    <div class="flex space-x-4">
                        <a href="#" class="bg-white/10 hover:bg-primary p-2 rounded-full transition-all">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start">
                            <svg class="w-5 h-5 mr-3 mt-1 text-primary" fill="none" stroke="currentColor"
                        ...
                        <li class="flex items-start">
                            ...
                            <span>info@digitalbhatti.com</span>
                        </li>
                    </ul>
                </div>
