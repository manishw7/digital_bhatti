...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = mysqli_prepare($conn, "INSERT INTO orders (user_id, food_id, quantity) VALUES (?, ?, ?)");
    ...
    mysqli_stmt_bind_param($stmt, "iii", $user_id, $food_id, $quantity); // "iii" means 3 integers
